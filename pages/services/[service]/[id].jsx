            ...
            <section className="lg:flex gap-x-6 ">
                ...
                <div className="pt-8 lg:w-[60%] mx-auto">
                    ...
                    <h1 className="text-black/80 my-6 text-xl">
                        ...
                        Nesciunt quidem vero corporis optio voluptate veniam sit
                        nisi, minima perferendis numquam aspernatur, voluptatum
                        enim natus. Ducimus reiciendis asperiores culpa nesciunt
                        voluptas?
                    </h1>
